...
const renderCurrentWeek = () => {
  ...
  document.getElementById("week-commits-count").textContent =
    weekCommits.length;
  ...
  if (weekCommits.length === 0 && weekIssues.length === 0) {
    listContainer.innerHTML =
      '<div class="placeholder-text" style="padding-top: 20px; font-style: italic; font-size: 0.7rem; color: #94a3b8;">Silêncio no repositório nesta semana.</div>';
  } else {
    listContainer.innerHTML =
      '<div class="placeholder-text" style="padding-top: 20px; font-size: 0.7rem; color: #22d3ee;">Atividade detectada. (Logs renderizados aqui)</div>';
  }
};
